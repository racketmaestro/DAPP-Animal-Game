...
public class DragandDrop : MonoBehaviour, IDragHandler, IEndDragHandler
{
    ...
    public bool IsSnappedToTarget(GameObject targetObject)
    {
        return Vector2.Distance(sourceRectTransform.anchoredPosition, targetObject.GetComponent<RectTransform>().anchoredPosition) < 50f;
    }
}
